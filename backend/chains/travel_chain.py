...
from utils.api_clients import get_city_coordinates, get_forecast_for_trip, get_current_weather, get_attractions, get_hotels, get_flights
...
def fetch_weather_for_trip_tool(query: str):
    ...
    try:
        ...
        city, start_date, end_date = map(lambda x: x.strip().strip("'\""), query.split(",")) # added strip to remove quotes
